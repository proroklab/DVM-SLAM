...
cmds[3]="source install/setup.bash && ros2 run orb_slam3_ros ros_mono --ros-args -p agentId:=1"

cmds[4]="source install/setup.bash && ros2 run orb_slam3_ros ros_mono --ros-args -p agentId:=2"
